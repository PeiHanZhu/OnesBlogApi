...
curl -X POST \
    ...
    -F "images[]=@/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpxLE99T" 
```
...
$response = $client->post(
    ...
    [
        ...
        'multipart' => [
            ...
            [
                'name' => 'images[]',
                'contents' => fopen('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpxLE99T', 'r')
            ],
        ],
    ]
);
...
url = 'http://ones-blog-api.test/api/posts/109/comments'
files = {
  'images[]': open('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpxLE99T', 'rb')
}
payload = {
    "content": "commentTest"
}
...
curl -X PUT \
    ...
    -F "_method=PUT" \
    -F "images[]=@/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpAqWeKx" 
```
...
$response = $client->put(
    ...
    [
        ...
        'multipart' => [
            ...
            [
                'name' => 'images[]',
                'contents' => fopen('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpAqWeKx', 'r')
            ],
        ],
    ]
);
...
files = {
  'images[]': open('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpAqWeKx', 'rb')
}
payload = {
    "content": "0724Comment",
    "_method": "PUT"
...
```bash
curl -X DELETE \
    "http://ones-blog-api.test/api/posts/109/comments/13" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {personal-access-token}"
```
...
url = 'http://ones-blog-api.test/api/posts/109/comments/13'
headers = {
  'Content-Type': 'application/json',
  'Accept': 'application/json',
  'Authorization': 'Bearer {personal-access-token}'
