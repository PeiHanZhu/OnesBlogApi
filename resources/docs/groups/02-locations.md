...
curl -X POST \
    ...
    -F "images[]=@/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/php66lR5Y" 
```
...
$response = $client->post(
    ...
    [
        ...
        'multipart' => [
            ...
            [
                'name' => 'images[]',
                'contents' => fopen('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/php66lR5Y', 'r')
            ],
        ],
    ]
);
...
url = 'http://ones-blog-api.test/api/locations'
files = {
  'images[]': open('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/php66lR5Y', 'rb')
}
payload = {
    "city_area_id": 153,
    "category_id": 2,
...
curl -X PUT \
    ...
    -F "_method=PUT" \
    -F "images[]=@/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpd5xN7C" 
```
...
$response = $client->put(
    ...
    [
        ...
        'multipart' => [
            ...
            [
                'name' => 'images[]',
                'contents' => fopen('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpd5xN7C', 'r')
            ],
        ],
    ]
);
...
url = 'http://ones-blog-api.test/api/locations/5'
files = {
  'images[]': open('/private/var/folders/l6/2wvm3yyn1blbsd_4c3_s2kb80000gn/T/phpd5xN7C', 'rb')
}
payload = {
    "city_area_id": 153,
    "category_id": 2,
